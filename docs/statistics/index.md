...
- **[Significance Testing](./significance.md)** - the Mann-Whitney U test for two groups and the Kruskal-Wallis omnibus test for three or more: why non-parametric, the algorithms, p-value interpretation, and custom tests.
